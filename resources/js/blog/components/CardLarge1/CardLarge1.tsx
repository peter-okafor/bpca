  ...
  return (
      ...
      >
          <div className="md:absolute z-10 md:left-0 md:top-1/2 md:-translate-y-1/2 w-full -mt-8 md:mt-0 px-3 sm:px-6 md:px-0 md:w-3/5 lg:w-1/2 xl:w-2/5">
              <div className="nc-CardLarge1__left p-4 sm:p-8 xl:py-14 md:px-10 bg-white bg-opacity-40 backdrop-filter backdrop-blur-lg shadow-lg rounded-lg space-y-3 sm:space-y-5 !border-opacity-0 -- nc-dark-box-bg">
                  ...
                  <div className="text-sm">
                      ...
                      <a
                          href={`${process.env.MIX_BLOG_URL}${href}`}
                          className="hover:text-pest-violet font-medium"
                      >
                          Read More
                      </a>
                  </div>
