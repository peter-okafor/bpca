...
const BgGlassmorphism: FC<BgGlassmorphismProps> = ({
  ...
  return (
    ...
    >
      <span className="bg-[#ef233c] w-80 h-80 rounded-lg mix-blend-multiply filter blur-3xl opacity-20 lg:w-96 lg:h-9w-96" />
      <span className="bg-[#04868b] w-80 h-80 ml-10 -mt-10 rounded-lg mix-blend-multiply filter blur-3xl opacity-20 lg:w-96 lg:h-9w-96 nc-animation-delay-2000" />
    </div>
  );
};
