...
const CardCategory4: FC<CardCategory4Props> = ({
  ...
  const { count, name, image, href = "/", thumbnail, color } = taxonomy;
  const getColorClass = () => {
    switch (color) {
      case "pink":
        return "bg-pink-500";
  ...
  return (
    ...
    >
      <div
        className={`flex-shrink-0 relative w-full aspect-w-7 rounded-lg aspect-h-5 h-0 overflow-hidden group`}
      >
        <NcImage
          src={image}
