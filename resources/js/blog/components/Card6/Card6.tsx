...
const Card6: FC<Card6Props> = ({ className = "h-full", post }) => {
    ...
    return (
        <div
            className={`nc-Card6 relative rounded-lg flex group flex-col-reverse sm:flex-row sm:items-center p-4  [ nc-box-has-hover ] [ nc-dark-box-bg-has-hover ] ${className}`}
            data-nc-id="Card6"
        >
            <Link
